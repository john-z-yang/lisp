...
TESTS = $(TESTDIR)/combine $(TESTDIR)/cons $(TESTDIR)/hof $(TESTDIR)/logic \
    $(TESTDIR)/macro $(TESTDIR)/parse $(TESTDIR)/quote $(TESTDIR)/pred \
	$(TESTDIR)/recur $(TESTDIR)/set $(TESTDIR)/varargs
