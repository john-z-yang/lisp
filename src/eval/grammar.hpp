...
const std::string defMacroGrammar = "(define-macro symbol (lambda ...))";
const uint8_t defMacroSymPos = 1;
const uint8_t defMacroExprPos = 2;
const uint8_t defMacroNilPos = 3;

const std::string ifGrammar = "(if expression_1 expression_2 expression_3)";
