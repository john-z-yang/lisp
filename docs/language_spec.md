...
| (**letrec** ((_sym<sub>1</sub> expr<sub>1</sub>_) ... (_sym<sub>n</sub> expr<sub>n</sub>_)) _body+_) | Equivalent to (**let** ((_sym<sub>1</sub> '()_) ... (_sym<sub>n</sub> '()_)) (set! _sym<sub>1</sub> expr<sub>1</sub>_) ... (set! _sym<sub>n</sub> expr<sub>n</sub>_) _body+_) |
